...
- Implementation planning: `.claude/skills/programming-workflow/SKILL.md`.
- Issue and pull request drafting: `.claude/skills/github-workflow/SKILL.md`.
- Documentation writing and maintenance: `.claude/skills/documentation-workflow/SKILL.md`.
- YouTube Analytics codebase discovery (architecture, database, sync, API, frontend, verification references): `.claude/skills/project-docs/SKILL.md`.
