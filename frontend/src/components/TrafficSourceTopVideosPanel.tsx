...
interface Props {
  ...
  /** True until both the ordering rows and the by-source videos have landed. */
  loading: boolean
  error?: string | null
}

export default function TrafficSourceTopVideosPanel({ rows, bySource, loading, error = null }: Props) {
  ...
  return (
    <div className="traffic-source-top-videos-section">
      ...
      <AsyncCard
        ...
        className="traffic-source-top-videos-card"
      >
