...
`docs/implementation-planning.md`, `docs/issue-authoring.md`, `docs/pull-request-authoring.md`, and this file own procedures: how to draft an issue, how to create an implementation plan, how to maintain documentation. They link to references instead of embedding detailed application knowledge.
...
- concise root verification commands in `AGENTS.md` may summarize `docs/verification.md`'s canonical guidance.
...
- application files changed only when the task genuinely required it (see `docs/verification.md`'s Documentation verification section).
