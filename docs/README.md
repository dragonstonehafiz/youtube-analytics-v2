...
| Database schema and queries | [`database.md`](database.md) |
| Synchronization and ingestion | [`sync.md`](sync.md) |
| HTTP endpoints and contracts | [`api.md`](api.md) |
| Frontend behavior and styling | [`frontend.md`](frontend.md) |
| Verification and implementation patterns | [`verification.md`](verification.md) |

Load only the references relevant to the current task; expand to another reference only when tracing the code reveals a dependency on it. Inspect current source code before asserting how something behaves — treat the code as authoritative whenever a reference conflicts with it, and correct the stale reference following [`documentation-maintenance.md`](documentation-maintenance.md).

## Documentation ownership

| Subject | Canonical file |
|---|---|
| System architecture and repository layout | [`architecture.md`](architecture.md) |
| Schema, relationships, and query behavior | [`database.md`](database.md) |
| Sync and ingestion behavior | [`sync.md`](sync.md) |
| HTTP contracts | [`api.md`](api.md) |
| Frontend types, clients, pages, components, styling | [`frontend.md`](frontend.md) |
| Verification commands and implementation patterns | [`verification.md`](verification.md) |
| Coding rules, safety/permission boundaries, scope control | [`repository-rules.md`](repository-rules.md) |
| Implementation-planning procedure | [`implementation-planning.md`](implementation-planning.md) |
| Issue-drafting procedure | [`issue-authoring.md`](issue-authoring.md) |
| PR-drafting procedure | [`pull-request-authoring.md`](pull-request-authoring.md) |
| Documentation maintenance procedure | [`documentation-maintenance.md`](documentation-maintenance.md) |
...
- For writing or correcting documentation, follow [`documentation-maintenance.md`](documentation-maintenance.md).
