...
This repository uses one issue template for every request — bugs, features, and enhancements alike. Read it to confirm its exact field set and requirements before drafting.
